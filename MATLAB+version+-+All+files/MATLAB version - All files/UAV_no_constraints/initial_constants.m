function constants=initial_constants()
    ...
    keySet={'Ix','Iy','Iz','m','g','Jtp','Ts','Q','S','R','ct','cq','l','controlled_states','hz','innerDyn_length','px','py','pz','trajectory'};
    constants_list={Ix Iy Iz m g Jtp Ts Q S R ct cq l controlled_states hz innerDyn_length px py pz trajectory};
