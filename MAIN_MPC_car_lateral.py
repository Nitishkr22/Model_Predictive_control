...
import support_files_car as sfc  ## import support file
...
r=constants['r'] # MAGNTUDE OF SINUSOIDAL FUNCTI
f=constants['f'] # FREQUENCY OF SINUSOIDAL FUNCTION
psi_ref,X_ref,Y_ref=support.trajectory_generator(t,r,f)
sim_length=len(t) # Number of control loop iteration
